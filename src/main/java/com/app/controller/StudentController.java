...
//	}
	...
	@GetMapping("/attendace/{studentId}")
	public  ResponseEntity<?> getattendace(@PathVariable Long studentId) {

		try {

			System.out.println("inside the attendace method");
			return ResponseEntity.ok(studentService.getattendance(studentId));
		} catch (RuntimeException e) {
			System.out.println("err in update  attend " + e);
