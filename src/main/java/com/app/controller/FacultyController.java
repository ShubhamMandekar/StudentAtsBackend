...
//	}
	...
	public ResponseEntity<?> presentstudent(@PathVariable String Id) {
		try {
			Long id=Long.parseLong(Id);
			System.out.println("inside the inc method");
			return ResponseEntity.ok(facultyService.incrementstudentattendance(id));
		} catch (RuntimeException e) {
			System.out.println("err in update  TimeTable " + e);
			return new ResponseEntity<>(new ApiResponse(e.getMessage()), HttpStatus.NOT_FOUND);
		}
	...
	@PatchMapping("/viewstudent/absent/{Id}")
	public ResponseEntity<?> absentstudent(@PathVariable String Id) {
		try {
			Long id=Long.parseLong(Id);
			System.out.println("inside the dec method");
			return ResponseEntity.ok(facultyService.decrementStudentattendance(id));
		} catch (RuntimeException e) {
			System.out.println("err in update  TimeTable " + e);
			return new ResponseEntity<>(new ApiResponse(e.getMessage()), HttpStatus.NOT_FOUND);
		}
